...
func RedisGetRequestBenchMark(numRequests int) {
	apiURL := "http://localhost:9010/profile/redis/get?profileID="
	numRequests += 500
	...
	err := common.WriteBurstStatsToCSV(individualBursts, "burst_stats_redis.csv")
	if err != nil {
